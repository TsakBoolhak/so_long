...
t_img	*foes_top_left(t_game *game, int frame, t_coord *pos, t_infos *content)
{
	int	mul;
...
t_img	*foes_bot_right(t_game *game, int frame, t_coord *pos, t_infos *content)
{
	int	mul;
